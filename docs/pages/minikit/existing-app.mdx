...
## Step 3: Using the useMiniKit Hook from Base
...
## Step 5: Generate Manifest for Farcaster
...
## Step 6: use generateMetadata from NextJS
...
When deploying to Vercel, add all the environment variables from your `.env` or `.env.local` file to your project settings:
