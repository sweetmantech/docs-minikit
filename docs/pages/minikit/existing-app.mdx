...
- **[Coinbase Developer Platform Account](https://www.coinbase.com/en-nl/developer-platform)** (Optional): Sign up for a Coinbase Developer Platform to retrieve your CDP API key.
