import {
  ...
  visit,
  zwitch
} from "./chunk-AMB7HMTO.js";
import {
  require_cjs
} from "./chunk-WY63DS7K.js";
import {
  require_acorn_jsx
} from "./chunk-5NJO6V6G.js";
import {
  require_extend
} from "./chunk-DT4FGQNS.js";
import {
  __commonJS,
  __export,
  __toESM
...
var require_utilities = __commonJS({
  "node_modules/.pnpm/style-to-js@1.1.16/node_modules/style-to-js/cjs/utilities.js"(exports) {
    "use strict";
...
var require_cjs2 = __commonJS({
  "node_modules/.pnpm/style-to-js@1.1.16/node_modules/style-to-js/cjs/index.js"(exports, module) {
    "use strict";
...
// node_modules/.pnpm/@mdx-js+mdx@3.1.0_acorn@8.14.1/node_modules/@mdx-js/mdx/lib/util/extnames.js
var md = markdown_extensions_default.map(function(d) {
  return "." + d;
});

// node_modules/.pnpm/@mdx-js+mdx@3.1.0_acorn@8.14.1/node_modules/@mdx-js/mdx/lib/util/resolve-file-and-options.js
        ...
        if (value && typeof value === "object") {
          if (Array.isArray(value)) {
            ...
            for (let i = 0; i < nodes.length; i += 1) {
              const item = nodes[i];
              if (isNode(item)) {
                if (!this.visit(item, node, key2, i)) {
                  i--;
                }
              }
            }
...
function toJs(tree, options) {
  const { SourceMapGenerator, filePath, handlers: handlers3 } = options || emptyOptions2;
...
function inherit(from, to) {
  ...
  if (left) {
    for (key2 in left) {
      if (own3.call(left, key2) && key2 !== "estree") {
        if (!right) right = {};
...
function mdxJsxToMarkdown(options) {
  ...
  function mdxElement(node, _, state, info) {
    const flow3 = node.type === "mdxJsxFlowElement";
    ...
    const prefix = (flow3 ? currentIndent : "") + "<" + (node.name || "");
...
function visit2(tree, visitor) {
  ...
  function build(node, key2, index2, parents) {
    ...
    return visit3;
    function visit3() {
      const result = enter ? toResult(enter(node, key2, index2, parents)) : [];
      if (result[0] === EXIT) {
        return result;
      }
      if (result[0] !== SKIP) {
        let cKey;
        for (cKey in node) {
          if (own5.call(node, cKey) && node[cKey] && typeof node[cKey] === "object" && // @ts-expect-error: custom esast extension.
      ...
      return leave ? toResult(leave(node, key2, index2, parents)) : result;
    }
  }
}
...
function eventsToAcorn(events, options) {
  ...
  try {
    ...
    ok(point4.offset !== void 0, "expected `offset`");
    error.pos = point4.offset;
    error.loc = { line: point4.line, column: point4.column - 1 };
    exception = error;
  ...
  function fixPosition(nodeOrToken) {
    ...
    ok(pointStart2.offset !== void 0, "expected `offset`");
    ok(pointEnd2.offset !== void 0, "expected `offset`");
...
function factoryMdxExpression(effects, ok2, type, markerType, chunkType, acorn, acornOptions, addResult, spread, allowEmpty, allowLazy) {
  ...
  function start2(code2) {
    ok(code2 === codes.leftCurlyBrace, "expected `{`");
    effects.enter(type);
  ...
  function before(code2) {
    ...
    if (code2 === codes.rightCurlyBrace && size === 0) {
  ...
  function inside(code2) {
    if (code2 === codes.rightCurlyBrace && size === 0 || code2 === codes.eof || markdownLineEnding(code2)) {
      effects.exit(chunkType);
      return before(code2);
    }
    if (code2 === codes.leftCurlyBrace && !acorn) {
      size += 1;
    } else if (code2 === codes.rightCurlyBrace) {
      size -= 1;
    }
    effects.consume(code2);
    return inside;
...
function mdxExpression2(options) {
  ...
  function tokenizeFlowExpression(effects, ok2, nok) {
    ...
    function after(code2) {
      return markdownSpace(code2) ? factorySpace(effects, end, types.whitespace)(code2) : end(code2);
    }
    function end(code2) {
      ...
      if (code2 === codes.lessThan && jsxTag) {
...
function factoryTag(effects, ok2, nok, acorn, acornOptions, addResult, allowLazy, tagType, tagMarkerType, tagClosingMarkerType, tagSelfClosingMarker, tagNameType, tagNamePrimaryType, tagNameMemberMarkerType, tagNameMemberType, tagNamePrefixMarkerType, tagNameLocalType, tagExpressionAttributeType, tagExpressionAttributeMarkerType, tagExpressionAttributeValueType, tagAttributeType, tagAttributeNameType, tagAttributeNamePrimaryType, tagAttributeNamePrefixMarkerType, tagAttributeNameLocalType, tagAttributeInitializerMarkerType, tagAttributeValueLiteralType, tagAttributeValueLiteralMarkerType, tagAttributeValueLiteralValueType, tagAttributeValueExpressionType, tagAttributeValueExpressionMarkerType, tagAttributeValueExpressionValueType) {
  ...
  function nameBefore(code2) {
    ...
    if (code2 !== codes.eof && code2 >= 0 && start(code2)) {
    ...
    crash(
      code2,
      "before name",
      "a character that can start a name, such as a letter, `$`, or `_`" + (code2 === codes.exclamationMark ? " (note: to create a comment in MDX, use `{/* text */}`)" : "")
    );
  }
  function closingTagNameBefore(code2) {
    ...
    crash(
      code2,
      "before name",
      "a character that can start a name, such as a letter, `$`, or `_`" + (code2 === codes.asterisk || code2 === codes.slash ? " (note: JS comments in JSX tags are not supported in MDX)" : "")
    );
  }
  function primaryName(code2) {
    if (code2 !== codes.eof && code2 >= 0 && cont(code2, { jsx: true })) {
      effects.consume(code2);
      return primaryName;
    }
    if (code2 === codes.dot || code2 === codes.slash || code2 === codes.colon || code2 === codes.greaterThan || code2 === codes.leftCurlyBrace || markdownLineEndingOrSpace(code2) || unicodeWhitespace(code2)) {
    ...
    crash(
      code2,
      "in name",
      "a name character such as letters, digits, `$`, or `_`; whitespace before attributes; or the end of the tag" + (code2 === codes.atSign ? " (note: to create a link in MDX, use `[text](url)`)" : "")
    );
  }
  function primaryNameAfter(code2) {
    ...
    if (code2 === codes.slash || code2 === codes.greaterThan || code2 === codes.leftCurlyBrace || code2 !== codes.eof && code2 >= 0 && start(code2)) {
  ...
  function localNameBefore(code2) {
    ...
    crash(
      code2,
      "before local name",
      "a character that can start a name, such as a letter, `$`, or `_`" + (code2 === codes.plusSign || code2 !== null && code2 > codes.dot && code2 < codes.colon ? " (note: to create a link in MDX, use `[text](url)`)" : "")
    );
  }
  ...
  function attributePrimaryNameAfter(code2) {
    ...
    if (code2 === codes.slash || code2 === codes.greaterThan || code2 === codes.leftCurlyBrace || markdownLineEndingOrSpace(code2) || unicodeWhitespace(code2) || code2 !== codes.eof && code2 >= 0 && start(code2)) {
      effects.exit(tagAttributeNameType);
  ...
  function attributeValueBefore(code2) {
    ...
    crash(
      ...
      "a character that can start an attribute value, such as `\"`, `'`, or `{`" + (code2 === codes.lessThan ? " (note: to use an element or fragment as a prop value in MDX, use `{<element />}`)" : "")
    );
  }
  ...
  function selfClosing(code2) {
    ...
    crash(
      ...
      "`>` to end the tag" + (code2 === codes.asterisk || code2 === codes.slash ? " (note: JS comments in JSX tags are not supported in MDX)" : "")
    );
  }
  ...
  function crash(code2, at2, expect) {
    const error = new VFileMessage(
      "Unexpected " + (code2 === codes.eof ? "end of file" : "character `" + (code2 === codes.graveAccent ? "` ` `" : String.fromCodePoint(code2)) + "` (" + serializeCharCode(code2) + ")") + " " + at2 + ", expected " + expect,
      self2.now(),
      "micromark-extension-mdx-jsx:unexpected-" + (code2 === codes.eof ? "eof" : "character")
    );
    error.url = trouble2 + (code2 === codes.eof ? "#unexpected-end-of-file-at-expected-expect" : "#unexpected-character-at-expected-expect");
    throw error;
  }
}
...
function jsxFlow(acorn, options) {
  ...
  function tokenizeJsxFlow(effects, ok2, nok) {
    ...
    function end(code2) {
      ...
      return code2 === codes.lessThan ? (
        // We can’t just say: fine. Lines of blocks have to be parsed until an eol/eof.
        start2(code2)
      ) : code2 === codes.leftCurlyBrace && expression ? effects.attempt(expression, end, nok)(code2) : code2 === codes.eof || markdownLineEnding(code2) ? ok2(code2) : nok(code2);
    }
  }
}
...
function mdxjsEsm2(options) {
  ...
  function tokenizeExportImport(effects, ok2, nok) {
    ...
    function start2(code2) {
      ok(
        code2 === codes.lowercaseE || code2 === codes.lowercaseI,
        "expected `e` or `i`"
      );
    ...
    function word(code2) {
      ...
      if ((buffer === "import" || buffer === "export") && code2 === codes.space) {
        effects.consume(code2);
        return inside;
      }
      return nok(code2);
    ...
    function atEnd(code2) {
      ...
      if (result.error) {
        if (code2 !== codes.eof && result.swallow) {
...
function createState2(tree, options) {
  ...
  function one(node, parent) {
    ...
    if (own7.call(state.handlers, type) && handle) {
...
function defaultUnknownHandler(state, node) {
  ...
  const result = "value" in node && !(own7.call(data2, "hProperties") || own7.call(data2, "hChildren")) ? { type: "text", value: node.value } : {
    type: "element",
    tagName: "div",
    properties: {},
    children: state.all(node)
...
function createVisitors() {
  ...
  function exit(node) {
    if (node.type === "ArrowFunctionExpression" || node.type === "FunctionDeclaration" || node.type === "FunctionExpression") {
      ...
      ok(scope, "expected scope");
      ok(!scope.block, "expected non-block");
      ...
      walk(tree, {
        enter(node) {
          if ((node.type === "ExportAllDeclaration" || node.type === "ExportNamedDeclaration" || node.type === "ImportDeclaration") && node.source) {
            ...
            create3(node.source, replacement2);
    ...
    function handleEsm(node) {
      ...
      if (outputFormat === "function-body") {
        if (
          ...
          ok(node.source, "expected `node.source` to be defined");
          const argument = { type: "ImportExpression", source: node.source };
          create3(node, argument);
...
function remarkMarkAndUnravel() {
  return function(tree) {
    visit(tree, function(node, index2, parent) {
      let offset2 = -1;
      let all2 = true;
      let oneOrMore = false;
...
// node_modules/.pnpm/@mdx-js+mdx@3.1.0_acorn@8.14.1/node_modules/@mdx-js/mdx/lib/compile.js
...
// node_modules/.pnpm/@mdx-js+mdx@3.1.0_acorn@8.14.1/node_modules/@mdx-js/mdx/lib/util/resolve-evaluate-options.js
...
// node_modules/.pnpm/@mdx-js+mdx@3.1.0_acorn@8.14.1/node_modules/@mdx-js/mdx/lib/run.js
...
// node_modules/.pnpm/@mdx-js+mdx@3.1.0_acorn@8.14.1/node_modules/@mdx-js/mdx/lib/evaluate.js
async function evaluate(file, options) {
  const { compiletime, runtime } = resolveEvaluateOptions(options);
  return run(await compile2(file, compiletime), runtime);
}
