...
// node_modules/.pnpm/@floating-ui+react@0.27.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@floating-ui/react/dist/floating-ui.react.mjs
var React2 = __toESM(require_react(), 1);

// node_modules/.pnpm/@floating-ui+react@0.27.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/@floating-ui/react/dist/floating-ui.react.utils.mjs
...
function NextFloatingDelayGroup(props) {
  ...
  const delayRef = React2.useRef(delay);
  const initialDelayRef = React2.useRef(delay);
  const currentIdRef = React2.useRef(null);
  const currentContextRef = React2.useRef(null);
  const timeoutIdRef = React2.useRef(-1);
...
function useNextDelayGroup(context, options) {
  ...
  const groupContext = React2.useContext(NextFloatingDelayGroupContext);
  const {
    currentIdRef,
    delayRef,
    timeoutMs,
  ...
  const [isInstantPhase, setIsInstantPhase] = React2.useState(false);
  index(() => {
    function unset() {
...
function FloatingPortal(props) {
  ...
  return (0, import_jsx_runtime.jsxs)(PortalContext.Provider, {
    ...
    children: [shouldRenderGuards && portalNode && (0, import_jsx_runtime.jsx)(FocusGuard, {
      ...
      style: HIDDEN_STYLES
    }), portalNode && ReactDOM.createPortal(children, portalNode), shouldRenderGuards && portalNode && (0, import_jsx_runtime.jsx)(FocusGuard, {
      "data-type": "outside",
      ref: afterOutsideRef,
      onFocus: (event) => {
        if (isOutsideEvent(event, portalNode)) {
...
function useListNavigation(context, props) {
  ...
  const forceSyncFocusRef = React2.useRef(false);
  ...
  const getParentOrientation = React2.useCallback(() => {
    var _tree$nodesRef$curren;
  ...
  const commonOnKeyDown = useEffectEvent((event) => {
    ...
    if (cols > 1) {
      ...
      const index2 = cellMap[getGridNavigatedIndex({
        ...
        // treat undefined (empty grid spaces) as disabled indices so we
        // don't end up in them
        disabledIndices: getGridCellIndices([...disabledIndices || listRef.current.map((_, index3) => isListIndexDisabled(listRef, index3) ? index3 : void 0), void 0], cellMap),
        minIndex: minGridIndex,
        maxIndex: maxGridIndex,
        prevIndex: getGridCellIndexOfCorner(
